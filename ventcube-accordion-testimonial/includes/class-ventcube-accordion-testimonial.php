...
class VentCube_Accordion_Testimonial_Widget extends \Elementor\Widget_Base {
    ...
    public function get_style_depends() {
        return [ 
            'ventcube-accordion-testimonial-style', 
            'ventcube-accordion-testimonial-responsive' 
        ];
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        'name' => 'client_name_mobile',
                        'label' => __( 'Client Name Mobile', 'ventcuebe' ),
                        'type' => \Elementor\Controls_Manager::TEXT,
                        'default' => __( 'Client Name', 'ventcuebe' ),
                        'label_block' => true,
                    ],
                ...
                'title_field' => '{{{ client_name }}} - {{{client_name_mobile}}} - {{{ year }}}',
            ]
        );
        
        $this->end_controls_section();

        // Main Accordion style control
        ...
        $this->add_responsive_control(
            'ventcube_accordion_main_margin',
            [
                'label' => __( 'Ventcube Accordion Margin', 'ventcuebe' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .ventcube-accordion' => 'margin: {{TOP}}{{UNIT}}; margin-right: {{RIGHT}}{{UNIT}}; margin-bottom: {{BOTTOM}}{{UNIT}}; margin-left: {{LEFT}}{{UNIT}};',
                ],
            ]
        );
 ...
 // =============================Accordion body area style control section========================= //
        ...
        $this->add_responsive_control(
            'ventcube_accordion_client_review_area_margin',
            [
                'label' => __( 'Ventcube Review Area Margin', 'ventcuebe' ),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .ventcube-accordion .client_review_area' => 'margin: {{TOP}}{{UNIT}}; margin-right: {{RIGHT}}{{UNIT}}; margin-bottom: {{BOTTOM}}{{UNIT}}; margin-left: {{LEFT}}{{UNIT}};',
                ],
            ]
        );
    ...
    $this->add_responsive_control(
        ...
        [
            'label' => __( 'Separator Border Color', 'ventcuebe' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .ventcube-accordion-body .ventcube-accordionSeparator' => 'border-color: {{VALUE}};',
            ],
    ...
    $this->add_responsive_control(
        ...
        [
            'label' => __( 'Separator Border Type', 'ventcuebe' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
            ...
            'default' => 'None',
            'selectors' => [
                '{{WRAPPER}} .ventcube-accordion-body .ventcube-accordionSeparator' => 'border-style: {{VALUE}};',
            ],
            'devices' => ['desktop', 'tablet', 'mobile'], // Responsive devices
    ...
    $this->add_responsive_control(
        ...
        [
            'label' => __( 'Separator Border Width', 'ventcuebe' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
            'selectors' => [
                '{{WRAPPER}} .ventcube-accordion-body .ventcube-accordionSeparator' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
            'devices' => ['desktop', 'tablet', 'mobile'], // Responsive devices
...
// =============================Right Button Style Controls===================================//
    ...
    protected function render() {
        ...
        if (!isset($settings['accordion_items']) || !is_array($settings['accordion_items'])) {
                    ...
                    <div class="ventcube-accordion-header" data-index="<?php echo $index; ?>">
                        <div class="ventcube-header-content">
                            <div class="ventcube-header-left">
                                ...
                                <span class="ventcube-client-name"><?php echo esc_html($item['client_name']); ?></span>
                            </div>
                            <div class="ventcube-header-middle-mobile">
                            <span class="ventcube-client-name-mobile"><?php echo esc_html($item['client_name_mobile']); ?></span>
                            </div>
                            <div class="ventcube-header-right">
                                <h2 class="ventcube-year"><?php echo esc_html($item['year']); ?></h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ventcube-main_row">
                            <div class="ventcube-column ventcube-left_column">
                                <div class="ventcube-row client_review_area">
                                    <p class="client_review_description"><?php echo esc_html($item['review_text']); ?></p>
                                </div>
                                <div class="ventcube-accordionSeparator"></div>
                                <div class="ventcube-additional_info_row">
                                    <h2><?php echo esc_html($item['additional_info_heading']); ?></h2>
                                    <ul>
                                        <?php if (isset($item['additional_info_items']) && is_array($item['additional_info_items'])) : ?>
                                            ...
                                            <?php endforeach; ?>
                                        <?php else : ?>
                                            <li>No additional info items found.</li>
                                        <?php endif; ?>
                                    </ul>
                                    <div class="ventcube-accordionSeparator"></div>
                                    <div class="ventcube-row_of_btn ventcube-desktop_version_ventcube">
                                        <a href="<?php echo esc_url($item['button_right_url']['url']); ?>" class="ventcube-button_right">
                                            <?php if ($item['button_right_icon_position'] === 'before') : ?>
                                                <?php \Elementor\Icons_Manager::render_icon($item['button_right_icon'], ['aria-hidden' => 'true', 'class' => 'ventcube-custom-icon-class']); ?>
                                            <?php endif; ?>
                    ...
                    <div class="ventcube-accordion-item {{ index === 0 ? 'active' : '' }}">
                        <div class="ventcube-accordion-header" data-index="{{ index }}">
                            <div class="ventcube-header-content">
                                ...
                                <div class="ventcube-header-middle-mobile">
                                <span class="ventcube-client-name">{{{ item.client_name_mobile }}}</span>
                            </div>
                                <div class="ventcube-header-right">
                        ...
                        <div class="ventcube-accordion-body {{ index === 0 ? 'active' : '' }}">
                            ...
                            <div class="ventcube-main_row">
                                <div class="ventcube-column ventcube-left_column">
                                    ...
                                    <div class="ventcube-accordionSeparator"></div>
                                    <div class="ventcube-additional_info_row">
                                        <h2>{{{ item.additional_info_heading }}}</h2>
                                        <ul>
                                            <# if (item.additional_info_items && item.additional_info_items.length) { #>
                                                <# _.each(item.additional_info_items, function(list_item) { #>
                                                    <li>
