    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .accordion-header .header-left .number' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .accordion-header .header-left .number' => 'margin-right: {{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .accordion-header .header-right h2' => 'margin-top: {{TOP}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .accordion-header' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .clint_work_image_row img ' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
 ...
 // =============================Accordion body area style control section========================= //
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Typography::get_type(),
              ...
              'selector' => '{{WRAPPER}} .left_column p',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .additional_info_row h2' => 'text-align: {{VALUE}};',
                ],
            ]
            );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .accordion-body' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'selectors' => [
                    '{{WRAPPER}} .accordion-body' => 'padding-top: {{TOP}}{{UNIT}}; padding-bottom: {{BOTTOM}}{{UNIT}};',
                ],
            ]
        );        
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'default' => 'column',
            'selectors' => [
                '{{WRAPPER}} .accordion-body .additional_info_row' => 'flex-direction: {{VALUE}};',
            ],
        ]
    );
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'selectors' => [
                '{{WRAPPER}} .accordion-body .additional_info_row' => 'margin: {{TOP}}{{UNIT}}; margin-right: {{RIGHT}}{{UNIT}}; margin-bottom: {{BOTTOM}}{{UNIT}}; margin-left: {{LEFT}}{{UNIT}};',
            ],
        ]
    );
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'default' => 'wrap',
            'selectors' => [
                '{{WRAPPER}} .accordion-body .additional_info_row ul' => 'flex-wrap: {{VALUE}};',
            ],
        ]
    );
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'selectors' => [
                '{{WRAPPER}} .accordion-body .additional_info_row ul' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]
    );
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li .additional-list-icon' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
            ],
        ]
    );
    ...
    $this->add_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li .span' => 'margin-left: {{SIZE}}{{UNIT}};'
            ],
        ]
    );
    ...
    $this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li svg.additional-list-icon' => 'color: {{VALUE}};',
            ],
        ]
    );
    ...
    $this->add_group_control(
        ...
        [
            ...
            'selector' => '{{WRAPPER}} .additional_info_row ul li span',
        ]
    );
	$this->add_control(
        ...
        [
            ...
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li span' => 'color: {{VALUE}};',
            ],
        ]
    );
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'size_units' => [ 'px', '%', 'em' ],
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]
    );
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'size_units' => [ 'px', '%', 'em' ],
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]
    );
    ...
    $this->add_group_control(
        ...
        [
            ...
            'selector' => '{{WRAPPER}} .additional_info_row ul li',
        ]
    );
    ...
    $this->add_control(
        ...
        [
            ...
            'size_units' => [ 'px', '%' ],
            'selectors' => [
                '{{WRAPPER}} .additional_info_row ul li' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]
    );
...
$this->add_responsive_control(
    ...
    [
        ...
        'selectors' => [
            '{{WRAPPER}} .button_right .custom-icon-class' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
            '{{WRAPPER}} .button_right .elementor-icon svg' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
        ],
    ]
);
...
// =============icon and text specing======================//
    ...
    $this->add_responsive_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}} .button_right .button-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
                '{{WRAPPER}} .button_right .elementor-icon svg' => 'margin-right: {{SIZE}}{{UNIT}};',
            ],
        ]
    );   
...
// =============================Right Button Style Controls===================================//
       ...
       // Button Normal State
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'left',
                'selectors' => [
                    '{{WRAPPER}} .row_of_btn .button_right' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        // Button Typography
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .button_right:hover',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .button_right:hover' => 'border-color: {{VALUE}};',
                ],
                'devices' => ['desktop', 'tablet', 'mobile'], // Responsive devices
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'None',
                'selectors' => [
                    '{{WRAPPER}} .button_right:hover' => 'border-style: {{VALUE}};',
                ],
                'devices' => ['desktop', 'tablet', 'mobile'], // Responsive devices
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .button_right:hover' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'devices' => ['desktop', 'tablet', 'mobile'], // Responsive devices
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .button_right' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'devices' => ['desktop', 'tablet', 'mobile'], // Responsive devices
    ...
    protected function render() {
        ...
        ?>
        <div id="accordion-<?php echo esc_attr($widget_id); ?>" class="accordion ventcube-accordion">
                        ...
                        <div class="accordion-header" data-index="<?php echo $index; ?>">
                            <div class="header-content">
                                ...
                                <div class="header-right">
                                    <h2 class="year"><?php echo $item['year']; ?></h2>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-body <?php echo $index === 0 ? 'active' : ''; ?>">
                            ...
                            <div class="main_row">
                                <div class="column left_column">
                                    <div class="row client_review_area">
                                    <p class="client_review_description"><?php echo $item['review_text']; ?></p>
                                </div>
                                    <div class="accordionSeparator"></div>
                                    <div class="additional_info_row">
                                        ...
                                        <ul>
                                            <?php if ( isset( $item['additional_info_items'] ) && is_array( $item['additional_info_items'] ) ) : ?>
                                                <?php foreach ( $item['additional_info_items'] as $list_item ) : ?>
                                                    ...
                                                    <li>
                                                        <?php \Elementor\Icons_Manager::render_icon($list_item['svg_icon'], ['aria-hidden' => 'true', 'class' => 'additional-list-icon']); ?>
                                        ...
                                        <div class="accordionSeparator"></div>
                                        <div class="row_of_btn desktop_version_ventcube">
                                ...
                                <div class="column right_column">
                                    <div class="clint_work_image_row">
                                        <img src="<?php echo esc_url($item['client_work_image']['url']); ?>" alt="<?php echo esc_attr($item['client_name']); ?>" class="work_image_client">
                                    </div>
                                    <div class="row_of_btn mobile_version_ventcube">
                                        <a href="<?php echo esc_url($item['button_right_url']['url']); ?>" class="button_right">
                                            <?php if ($item['button_right_icon_position'] === 'before') : ?>
                                                <?php \Elementor\Icons_Manager::render_icon( 
                                                    $item['button_right_icon'], 
    ...
    protected function content_template() {
        ?>
        <div id="accordion-{{{ view.getID() }}}" class="accordion ventcube-accordion">
                ...
                <# _.each(settings.accordion_items, function(item, index) { #>
                    <div class="accordion-item {{ index === 0 ? 'active' : '' }}">
                        <div class="accordion-header" data-index="{{ index }}">
                            <div class="header-content">
                                <div class="header-left">
                                    <span class="number">{{{ ('0' + (index + 1)).slice(-2) }}}</span>
                            ...
                            <div class="main_row">
                                ...
                                <div class="column right_column">
                                    ...
                                    <div class="row_of_btn">
                                        <a href="{{{ item.button_right_url.url }}}" class="button_right">
                                            <# if (item.button_right_icon_position === 'before') { #>
                                                <i class="{{ item.button_right_icon.value }}"></i>
                                            <# } #>
                                            <span class="button-text">{{{ item.button_right_text }}}</span>
